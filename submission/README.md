...
| File | Description |
|------|-------------|
| `main.tex` | Main LaTeX source (BIB-formatted) |
| `main.pdf` | ~19 pages compiled |
| `references.bib` | 45 references |
| `figures/figure1_schematic_cropped.pdf` | Figure 1: Study schematic |
...
| File | Description |
|------|-------------|
| `supplementary.pdf` | Expanded supplementary (tables + figures + sensitivity analysis) |
...
8. **References** — 45 citations covering GPCR biology, PLMs, PPI prediction, and evaluation methodology
...
## Pre-Submission Cleanup (all items completed)
...
5. **Practical utility**: Moderately calibrated (Brier 0.163 CA / 0.135 SVM; constant-predictor baseline 0.190), high-confidence subset ($\ge$0.98) at 89.0% accuracy

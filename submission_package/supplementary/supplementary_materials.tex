...
All source code, raw pairing matrices, cluster assignments, and evaluation scripts are available at \url{https://github.com/nblvguohao/gpcr-coupling-leakage-benchmark}. The repository contains:
\begin{itemize}

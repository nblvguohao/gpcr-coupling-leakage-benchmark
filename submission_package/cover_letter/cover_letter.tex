...
All source code, curated datasets, pre-computed features, and trained model weights are freely available at \url{https://github.com/nblvguohao/gpcr-coupling-leakage-benchmark} under the MIT license, and permanently archived on Zenodo (DOI to be assigned upon acceptance).

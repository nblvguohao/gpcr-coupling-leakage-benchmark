...
The full dataset of 1,647 (GPCR, G protein family) pairs with coupling labels is provided in \texttt{paired\_dataset/pairing\_matrix\_raw.csv}. Pre-computed ESM-2 embeddings (8M and 650M) are available in NumPy format in \texttt{paired\_dataset/}. Cross-validation fold assignments and CD-HIT cluster memberships are provided in \texttt{paired\_dataset/cv\_folds.json} and \texttt{paired\_dataset/sequence\_clusters.json}. All data is archived on Zenodo with DOI 10.5281/zenodo.XXXXXXX.

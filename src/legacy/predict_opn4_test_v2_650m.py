#!/usr/bin/env python3
"""
对 OPN4 测试数据进行 V2 增强特征预测 (650M ESM-2 版本)。
"""
...
print("=" * 70)
print("  OPN4 测试集 V2 预测（650M ESM-2，目标：能否激活人源 GNAQ）")
print("=" * 70)
...
# 构建训练集 (icl_stats_v2: 2560+16+2=2578-d)
X_train, y_train = [], []
skipped = 0
...
print("[INFO] 650M V2 SVM trained")
...
print("\n" + "=" * 70)
print("  650M V2 模型预测（icl_stats_v2: 2578-d）")
print("=" * 70)
